...
def check_user_input():
    ...
    # сейчас реализовал в соответствии с третьим пунктом. Не совсем понимаю, как можно без цикла IF/ELSE в
    ...
    while True:
        ...
        # TODO, этот цикл можно упростить. Сложный получился.
        #  попробуйте print(list('1234')) или так print(list(map(int, '1234')))
        for value in range(len(user_input)):
            user_number_list += [int(str(user_input)[value])]

        # TODO, вот эту чать, лучше разбить на несколько.
        #  Выходить из условного оператора if/else лучше с помощью return user_number_list. Чуть меньше будет кода.
