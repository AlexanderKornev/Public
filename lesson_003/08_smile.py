...
# TODO, в модуле simple_draw есть функция, которая возвращает рандомную точку. Если зажать Ctrl и нажать
#  на название модуля модуля левой кнопкой мыши, попадёте в модуль simple_draw, сможете ознакомиться
#  со всеми функциями модуля.
#  Получив рандомную точку, мы можем взять необходимые "x" и "y" из аргументов точки point.x и point.y.
#  Вычисления ("+=") в коде ниже не нужны.
